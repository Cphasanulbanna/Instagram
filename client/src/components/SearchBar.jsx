...
export const SearchBar = () => {
    ...
    return (
        <div
            ...
            className={`search-bar max-w-[400px] w-[100%] border-r-[1px] border-r-solid border-r-text-grey h-[100vh] rounded-[10px] overflow-hidden absolute z-[-1] left-[-320px] bg-text-white`}
        >
